...
Upload your completed versions of `kmeans.py`, `cluster.py`, `point.py`, and `gmm.py` to Gradescope.
Do NOT change the names of the submissions files, this will cause autograder to fail and an automatic zero will be assigned.